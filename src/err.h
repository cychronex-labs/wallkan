...
typedef enum WkResult {
    ...
    WK_ERR_MAX_AMOUNT_MONITORS,
    WK_ERR_NO_ACTIVE_MONITORS_FOUND,
    WK_ERR_UNDISCOVERED_MONITOR,
    WK_ERR_OUTPUT_ENABLE,
    ...
    WK_ERR_VK_PHYSICAL_DEVICE_ENUMERATION_FAILURE,
    WK_ERR_VK_NO_PHYSICAL_DEVICE_FOUND,
    WK_ERR_VK_DEVICE_EXT_ENUMERATION_FAILED,
    WK_ERR_VK_DEVICE_SUPPORT_SURFACE_PRESENTATION_FAILURE,
    WK_ERR_VK_LOGICAL_DEVICE_CREATION_FAILURE,
    WK_ERR_VK_FAILED_TO_GET_QUEUE,

    WK_ERR_VK_CANNOT_GET_SURFACE_CAPABILITY,
    WK_ERR_VK_CANNOT_GET_SURFACE_FORMATS,
    WK_ERR_VK_SWAPCHAIN_CREATION_FAILURE,
    WK_ERR_VK_CANNOT_GET_SWAPCHAIN_IMAGES,
    WK_ERR_VK_CANNOT_CREATE_IMAGE_VIEW
} WkResult;
